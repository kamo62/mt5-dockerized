...
rsync -az --delete --exclude node_modules --exclude dist --exclude dist-types \
  /Users/kamogelo/Code/linux-mt5/ kamo@192.168.0.100:/home/kamo/linux-mt5/

ssh kamo@192.168.0.100 'mkdir -p /home/kamo/linux-mt5-data && cd /home/kamo/linux-mt5 && docker-compose up -d --build'
```
...
When using the default Compose file this is backed by:

```text
/home/kamo/linux-mt5-data
```
...
APP_PORT=17300
NOVNC_PORT=17080
MT5_DATA_DIR=/home/kamo/linux-mt5-data
PUBLIC_NOVNC_URL=http://192.168.0.100:17080/vnc.html?autoconnect=1&resize=scale&path=websockify
